...
export type TimelineItemsDataFragment = (
  { __typename?: 'PullRequest' }
  & { timelineItems: (
    { __typename?: 'PullRequestTimelineItemsConnection' }
    & { pageInfo: (
...
export type PullRequestDataFragment = (
  { __typename?: 'PullRequest' }
...
export type PullRequestQuery = (
  ...
  & { repository?: Maybe<(
    ...
    & { pullRequest?: Maybe<(
      { __typename?: 'PullRequest' }
      & PullRequestDataFragment
      & TimelineItemsDataFragment
    )> }
  )> }
);

export type InitialPullRequestsQueryVariables = Exact<{
  name: Scalars['String'];
  owner: Scalars['String'];
}>;


export type InitialPullRequestsQuery = (
  { __typename?: 'Query' }
  & { repository?: Maybe<(
    { __typename?: 'Repository' }
    & { pullRequests: (
...
export type PaginatedPullRequestsQueryVariables = Exact<{
  name: Scalars['String'];
  owner: Scalars['String'];
...
export type PaginatedPullRequestsQuery = (
  { __typename?: 'Query' }
  & { repository?: Maybe<(
    { __typename?: 'Repository' }
    & { pullRequests: (
